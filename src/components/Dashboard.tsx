      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 shadow-sm z-10">
          ...
          <h1 className="text-xl font-bold text-gray-800">
            {activeTab === 'monitor' && <span>Monitor de Flota</span>}
            {activeTab === 'drivers' && <span>Gestión de Conductores</span>}
            {activeTab === 'passengers' && <span>Directorio de Pasajeros</span>}
            {activeTab === 'trips' && <span>Historial de Viajes</span>}
            {activeTab === 'settings' && <span>Configuración del Sistema</span>}
          </h1>
